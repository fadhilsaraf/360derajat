...
<html lang="en">
    ...
    <body>
       <div class="container" style="width:100%">
		...
		<h1>MEMBER LOGIN</h1>
		<form action="loginproses.php" id="lg-form" name="lg-form" method="post">
			...
			<text style= "margin-left: 348px">Havent ID yet? </text>
			<a href ="signup.php" style= "margin-left: 400px">SIGNUP</a>
	</div>
